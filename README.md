Here I filter out the Moulvibazar sadar upazilla by using filter method and filter object. Then I add layer to separate the upazilla from the rest and color it as red to visualize it finely.
